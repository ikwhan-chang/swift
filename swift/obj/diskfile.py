...
class BaseDiskFileWriter(object):
    ...
    def write(self, chunk):
        ...
        print self._fd
        print self._tmppath
        print self._bytes_per_sync
        print self._diskfile

        # Internal attributes
        print self._upload_size
        print self._last_sync
    ...
    def _finalize_put(self, metadata, target_path, cleanup):
        ...
        if "_compressed" not in metadata['name']:
          ...
          command = "ls /var/tmp/;swift -A http://10.240.0.5/auth/v1.0 -U test:tester -K testing upload Compressed /var/tmp/"+image_name+"_compressed.jpg"
          print command
